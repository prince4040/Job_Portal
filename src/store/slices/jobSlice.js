...
export const fetchJobs = (city, niche, searchKeyword = "") => async (dispatch) => {
    try {
        ...
        let link = "https://job-portal-hkhc.onrender.com/api/v1/job/getall?";
        let queryParams = [];
        if (searchKeyword) {
...
export const fetchSingleJob = (jobId) => async (dispatch) => {
    ...
    try {
        const response = await axios.get(`https://job-portal-hkhc.onrender.com/api/v1/job/get/${jobId}`, { withCredentials: true });
...
export const postJob = (data) => async (dispatch) => {
    ...
    try {
        const response = await axios.post(
            `https://job-portal-hkhc.onrender.com/api/v1/job/post`,
            data,
...
export const getMyJobs = () => async (dispatch) => {
    ...
    try {
        const response = await axios.get(
            `https://job-portal-hkhc.onrender.com/api/v1/job/getmyjobs`,
...
export const deleteJob = (id) => async (dispatch) => {
    ...
    try {
        const response = await axios.delete(`https://job-portal-hkhc.onrender.com/api/v1/job/delete/${id}`, { withCredentials: true });
