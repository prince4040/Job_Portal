  ...
  return (
    <div className='account_components'>
      ...
      <div>
        ...
        <textarea value={responsibilities} onChange={(e) => setResponsibilities(e.target.value)} placeholder='Job Responsibilities' rows={7} />
      </div>
      ...
      <div>
        <label>Salary</label>
        <input type="text" value={salary} onChange={(e) => setSalary(e.target.value)} placeholder='50000 - 800000' />
      </div>

      <div>
        <div className='label-infoTag-wrapper'>
          <label>Hiring Multiple Cnadidates?</label>
          <span><CiCircleInfo /> Optional</span>
        </div>
        <select value={hiringMultipleCandidates} onChange={(e) => setHiringMultipleCandidates(e.target.value)}>
          <option value="">Hiring Multiple Cnadidates?</option>
      ...
      <div>
        <div className='label-infoTag-wrapper'>
          <label>Personal Webdite Name</label>
          <span><CiCircleInfo /> Optional</span>
        </div>
        <input type="text" value={personalWebsiteTitle} onChange={(e) => setPersonalWebsiteTitle(e.target.value)} placeholder='Personal Webdite Name/Title'/>
      </div>

      <div>
        <div className='label-infoTag-wrapper'>
          <label>Personal Webdite Link (URL)</label>
          <span><CiCircleInfo /> Optional</span>
        </div>
        <input type="text" value={personalWebsiteUrl} onChange={(e) => setPersonalWebsiteUrl(e.target.value)} placeholder='Personal Webdite Link (URL)'/>
      </div>

      <div>
        <button style={{margin: "0 auto"}} className='btn' onClick={hanldePostJob} disabled={loading}>
          Post Job
        </button>
      </div>
